...
- Documentation dose not disappear from modal https://github.com/gravitee-io/issues/issues/6004[#6004]
...
- APIM helm does not support pod.spec.topologySpreadConstraints https://github.com/gravitee-io/issues/issues/7313[#7313]
- Chart 3.1.35 mongodb replicaset no more deployed compared to previous version 3.1.32 https://github.com/gravitee-io/issues/issues/7478[#7478]
