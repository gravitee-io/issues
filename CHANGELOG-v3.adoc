...
- Transfer ownership option is not available to org admin (in memory admin) if primary owner is other user. https://github.com/gravitee-io/issues/issues/7430[#7430]

*_Console_*

- APIs not showing in a selected User when the Group they are in is Updated. https://github.com/gravitee-io/issues/issues/7285[#7285]
