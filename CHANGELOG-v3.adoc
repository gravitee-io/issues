...
- Reporter filelog file are not created https://github.com/gravitee-io/issues/issues/8065[#8065]
...
- OpenAPI specification of the Portal API is no longer available https://github.com/gravitee-io/issues/issues/8074[#8074]
