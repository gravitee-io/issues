...
- Alerts - Add a description field for alert https://github.com/gravitee-io/issues/issues/6803[#6803]
- Alerts - Allow alert configuration by API https://github.com/gravitee-io/issues/issues/6702[#6702]
...
- Remove Spring context at API level https://github.com/gravitee-io/issues/issues/6491[#6491]

*_Policies_*

- Improve conditional policy icon style https://github.com/gravitee-io/issues/issues/6823[#6823]
