...
- Query params are not well displayed https://github.com/gravitee-io/issues/issues/7779[#7779]

*_Management_*

- Can not import Paths Based API https://github.com/gravitee-io/issues/issues/8365[#8365]
