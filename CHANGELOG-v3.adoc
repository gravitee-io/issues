...
- APIM - Search APIs by their labels causing unexpected results https://github.com/gravitee-io/issues/issues/6432[#6432]
...
- User created from AM cannot connect to APIM, if newsletter is enabled https://github.com/gravitee-io/issues/issues/6572[#6572]
...
- Disable label display on home & list page https://github.com/gravitee-io/issues/issues/6522[#6522]
- Display of Applications may take too long and should be paginated https://github.com/gravitee-io/issues/issues/6020[#6020]
- Main Documentation anchor doesn't work https://github.com/gravitee-io/issues/issues/6905[#6905]
