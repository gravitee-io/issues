...
- List of API's from a user, not showing correctly https://github.com/gravitee-io/issues/issues/8346[#8346]

*_Policy_*

- XSLT parameter get cached depending on the number of gateways https://github.com/gravitee-io/issues/issues/8382[#8382]
- [cache] strange behaviour when policy cache TTL is higher than resource cache TTL https://github.com/gravitee-io/issues/issues/7907[#7907]
