...
- Server unreachable error is displayed when searching for apps on API- Subscription page, when there are multiple apps with similar name https://github.com/gravitee-io/issues/issues/8329[#8329]
